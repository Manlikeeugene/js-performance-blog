...
//   const cookieStore = await cookies(); // Await for async resolution
...
//   if (!res.ok) {
//     console.error('API response status:', res.status); // Debug: Check for 401, etc.
...
//     initialPosts = []; // Empty for "no data" UI
//   }

//   return (
//     <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
//       <Navbar showPostsLink={true} showFeatures={false} showTech={false} />
//       <Dashboard initialPosts={initialPosts} userId={session.user.id} />
//       <Footer />
//     </div>
//   );
// }
