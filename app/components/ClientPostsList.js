...
// export default function ClientPostsList({ initialPosts, baseUrl }) {
...
//         setPosts(initialPosts); // Fallback to dummy data
//         setError('Failed to load posts. Showing demo data.');
//       } finally {
//         setLoading(false);
//       }
//     }
...
export default function ClientPostsList({ baseUrl }) {
